    ...
    <div class="flex h-screen">
        <aside class="w-64 dark-theme-aside p-4 flex flex-col shadow-lg">
            ...
            <div class="mt-auto p-2">
                 <button onclick="loadPage('loginweb.php',this)" class="w-full bg-red-600 text-white px-4 py-3 rounded-lg font-bold text-sm hover:bg-red-700 flex items-center justify-center gap-2">
        ...
        <div class="flex-1 flex flex-col">
            <header class="dark-theme-header px-6 py-3 flex items-center justify-between shadow-md z-10">
                ...
                <div class="flex items-center gap-4 text-sm">
                    ...
                    <button class="text-gray-600 hover:text-red-600"><svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 6h16M4 12h16M4 18h16"></path></svg></button>
                </div>
            </header>
                ...
                <script>
                    ...
                    document.addEventListener('DOMContentLoaded', () => {
                        ...
                        try {
                            ...
                            <div id="device-connected-list" class="space-y-3">
        ...
        <div class="bg-white rounded-lg shadow-2xl w-80 overflow-hidden text-gray-900">
            ...
            <div class="p-4 bg-gray-50 space-y-4">
                ...
                <div class="space-y-2">
                    ...
                    <button onclick="alert('Calling Resident...')" class="w-full bg-blue-600 hover:bg-blue-700 text-white py-2.5 px-4 rounded-lg font-medium text-sm flex items-center justify-center gap-2"><svg class="w-4 h-4" fill="currentColor" viewBox="0 0 20 20"><path d="M2 3a1 1 0 011-1h2.153a1 1 0 01.986.836l.74 4.435a1 1 0 01-.54 1.06l-1.548.773a11.037 11.037 0 006.105 6.105l.774-1.548a1 1 0 011.059-.54l4.435.74a1 1 0 01.836.986V17a1 1 0 01-1 1h-2C7.82 18 2 12.18 2 5V3z"></path></svg>Call Resident</button>
                </div>
            </div>
        </div>
    </div>
...
async function loadExternalContent(url, contentId, buttonElement) {
    ...
    try {
        ...
        // Execute scripts to define local functions
...
function interceptFormSubmissions(sourceUrl) {
    ...
    forms.forEach(form => {
        form.addEventListener('submit', async (e) => {
            ...
            const action = form.action || sourceUrl;
